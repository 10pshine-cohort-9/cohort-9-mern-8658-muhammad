  ...
  return (
    ...
    >
      <div className="  ">
        ...
        <div className="mx-4">
          <button aria-label="Create new note" className=" flex w-full items-center  gap-2 rounded-full bg-gradient-to-r from-violet-500 to-sky-500 px-4 py-2 text-sm font-semibold text-white transition hover:opacity-90">
